package com.dragonbyte.wikimedia.producer.stream;


import com.dragonbyte.wikimedia.producer.producer.WikimediaProducer;
...
public class WikimediaStreamConsumer {
    ...
    public  void consumeStreanAndPublish(){
        webClient.get()
